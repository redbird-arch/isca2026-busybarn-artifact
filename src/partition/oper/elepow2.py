...
"""Partition elementwise square or power-of-two style operators."""
...
class elepow2(elementwise_oper):
...
def elepow2_data(
    ...
    """Create data for element-wise power of 2 operation.
...
def Elepow2(
    ...
    """Initialize and build an element-wise power of 2 operator.
    ...
    Returns:
        ...
        elepow2_instance: The initialized elepow2 operator instance
    """
    source_data_tag_list, target_data_tag_list, next_online_data_tag, next_offline_data_tag = elepow2_data(
        data_dict=data_dict,
        oper_name=oper_name,
        oper_split_list=oper_split_list,
    ...
    elepow2_instance.build_dependency(
        data_dict=data_dict,
        beha_dict=beha_dict
    )

    next_oper_tag = oper_tag[:-1] + (oper_tag[-1]+1,)
    next_beha_offset = beha_tag_offset + elepow2_instance.degrees

    return next_oper_tag, next_online_data_tag, next_offline_data_tag, next_beha_offset, elepow2_instance
